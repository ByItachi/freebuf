...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    date: "Jan 28, 2026",
    tag: "Product",
    excerpt: "A faster agent, deeper framework support and a new layer of design control — meet Freebuff 2.0.",
    body: [
      "Freebuff 2.0 is the biggest upgrade to the platform yet: a rebuilt agent that plans before it builds, full-stack reasoning across your frontend, backend and data, and far more reliable edits to existing projects.",
      ...
      "Under the hood, builds are faster, previews load sooner and deployments stay zero-config. Everything you loved about Freebuff, with the rough edges sanded off.",
    ],
  },
  {
  ...
  {
    slug: "a-founders-guide-to-freebuff-security",
    cover: "Security%20Founders%20Marketing%20Design.png",
    title: "A founder's guide to Freebuff security",
    date: "Oct 30, 2025",
    tag: "Security",
    excerpt: "What actually keeps your app and customer data safe: SSO, RBAC, scanning, isolation and data controls.",
    body: [
      "Security questions come up in almost every serious build. Here's the short version of how Freebuff protects your work: everything runs in isolated projects, secrets are stored encrypted and never baked into code, and every publish can be gated behind approvals.",
  ...
  {
    slug: "gpt-5-5-now-in-freebuff",
    cover: "gpt-5-5.jpeg",
    title: "GPT-5.5 now in Freebuff",
    date: "Sep 14, 2025",
    tag: "Models",
    excerpt: "The newest flagship model is available in the model picker for every project.",
    body: [
      "GPT-5.5 is now available across Freebuff. It brings stronger reasoning for complex multi-file edits, better adherence to long instructions, and noticeably cleaner first drafts of full-stack features.",
  ...
  {
    slug: "one-year-of-freebuff",
    cover: "screenshot-2025-11-18-at-14.06.24.png",
    title: "One year of Freebuff",
    date: "Nov 20, 2025",
    tag: "Company",
    excerpt: "From a weekend prototype to millions of builders: a look back at year one.",
    body: [
      "A year ago Freebuff was a small experiment in letting GPT write whole apps. Today millions of people have prompted ideas into existence — startups, internal tools, portfolios, games and everything in between.",
